...
DROP FUNCTION IF EXISTS oph_gsl_correlation;
...
DROP FUNCTION IF EXISTS oph_zonal_stats;
...
CREATE FUNCTION oph_gsl_correlation RETURNS STRING SONAME 'liboph_gsl_correlation.so';
...
CREATE FUNCTION oph_zonal_stats RETURNS STRING SONAME 'liboph_zonal_stats.so';
