...
{
    if(args->arg_count != 3){
            strcpy(message, "ERROR: Wrong arguments! oph_cast(input_OPH_TYPE, output_OPH_TYPE, measure)");
            return 1;
    }
    ...
    if (input->type == output->type) {
        ...
        case OPH_INT:
            ...
            case OPH_LONG: //int->long
                for (i = 0; i < input->numelem; i++) {
                    ((long long *)(output->content))[i] = (long long) ((int *)(input->content))[i];
                }
                break;
            case OPH_SHORT: //int->short
                for (i = 0; i < input->numelem; i++) {
                    ((short *)(output->content))[i] = (short) ((int *)(input->content))[i];
                }
                break;
            case OPH_BYTE: //int->byte
                for (i = 0; i < input->numelem; i++) {
                    ((char *)(output->content))[i] = (char) ((int *)(input->content))[i];
                }
                break;
            case OPH_FLOAT: //int->float
                for (i = 0; i < input->numelem; i++) {
                    ((float *)(output->content))[i] = (float) ((int *)(input->content))[i];
                }
                break;
            case OPH_DOUBLE: //int->double
                for (i = 0; i < input->numelem; i++) {
                    ((double *)(output->content))[i] = (double) ((int *)(input->content))[i];
                }
                break;
        ...
        case OPH_SHORT:
            ...
            case OPH_LONG: //short->long
                for (i = 0; i < input->numelem; i++) {
                    ((long long *)(output->content))[i] = (long long) ((short *)(input->content))[i];
                }
                break;
            case OPH_INT: //short->int
                for (i = 0; i < input->numelem; i++) {
                    ((int *)(output->content))[i] = (int) ((short *)(input->content))[i];
                }
                break;
            case OPH_BYTE: //short->byte
                for (i = 0; i < input->numelem; i++) {
                    ((char *)(output->content))[i] = (char) ((short *)(input->content))[i];
                }
                break;
            case OPH_FLOAT: //short->float
                for (i = 0; i < input->numelem; i++) {
                    ((float *)(output->content))[i] = (float) ((short *)(input->content))[i];
                }
                break;
            case OPH_DOUBLE: //short->double
                for (i = 0; i < input->numelem; i++) {
                    ((double *)(output->content))[i] = (double) ((short *)(input->content))[i];
                }
                break;
            case OPH_COMPLEX_INT: //short->cint
                for (i = 0; i < input->numelem; i++) {
                    ((int *)(output->content))[j] = ((short *)(input->content))[i];
                    ((int *)(output->content))[j+1] = 0;
                    j+=2;
                }
                break;
        ...
        case OPH_BYTE:
            ...
            case OPH_LONG: //byte->long
                for (i = 0; i < input->numelem; i++) {
                    ((long long *)(output->content))[i] = (long long) ((char *)(input->content))[i];
                }
                break;
            case OPH_SHORT: //byte->short
                for (i = 0; i < input->numelem; i++) {
                    ((short *)(output->content))[i] = (short) ((char *)(input->content))[i];
                }
                break;
            case OPH_INT: //byte->int
                for (i = 0; i < input->numelem; i++) {
                    ((int *)(output->content))[i] = (int) ((char *)(input->content))[i];
                }
                break;
            case OPH_FLOAT: //byte->float
                for (i = 0; i < input->numelem; i++) {
                    ((float *)(output->content))[i] = (float) ((char *)(input->content))[i];
                }
                break;
            case OPH_DOUBLE: //byte->double
                for (i = 0; i < input->numelem; i++) {
                    ((double *)(output->content))[i] = (double) ((char *)(input->content))[i];
                }
                break;
        ...
        case OPH_LONG:
            ...
            case OPH_INT: //long->int
                for (i = 0; i < input->numelem; i++) {
                    ((int *)(output->content))[i] = (int) ((long long *)(input->content))[i];
                }
                break;
            case OPH_SHORT: //long->short
                for (i = 0; i < input->numelem; i++) {
                    ((short *)(output->content))[i] = (short) ((long long *)(input->content))[i];
                }
                break;
            case OPH_BYTE: //long->byte
                for (i = 0; i < input->numelem; i++) {
                    ((char *)(output->content))[i] = (char) ((long long *)(input->content))[i];
                }
                break;
            case OPH_FLOAT: //long->float
                for (i = 0; i < input->numelem; i++) {
                    ((float *)(output->content))[i] = (float) ((long long *)(input->content))[i];
                }
                break;
            case OPH_DOUBLE: //long->double
                for (i = 0; i < input->numelem; i++) {
                    ((double *)(output->content))[i] = (double) ((long long *)(input->content))[i];
                }
                break;
        ...
        case OPH_FLOAT:
            ...
            case OPH_INT: //float->int
                for (i = 0; i < input->numelem; i++) {
                    if (isnanf(((float *)(input->content))[i])) {
            ...
            case OPH_DOUBLE: //float->double
                for (i = 0; i < input->numelem; i++) {
                    if (isnanf(((float *)(input->content))[i])) {
                        ((double *)(output->content))[i] = 0.0/0.0;
                    } else {
            ...
            case OPH_COMPLEX_FLOAT: //float->cfloat
                for (i = 0; i < input->numelem; i++) {
                    if (isnanf(((float *)(input->content))[i])) {
                        ...
                        ((float *)(output->content))[j+1] = 0.0/0.0;
                        j+=2;
                    } else {
                        ((float *)(output->content))[j] = ((float *)(input->content))[i];
                        ((float *)(output->content))[j+1] = 0;
            ...
            case OPH_COMPLEX_DOUBLE: //float->cdouble
                for (i = 0; i < input->numelem; i++) {
                    if (isnanf(((float *)(input->content))[i])) {
                        ((double *)(output->content))[j] = 0.0/0.0;
                        ((double *)(output->content))[j+1] = 0.0/0.0;
                        j+=2;
                    } else {
        ...
        case OPH_DOUBLE:
            ...
            case OPH_INT: //double->int
                for (i = 0; i < input->numelem; i++) {
                    if (isnan(((double *)(input->content))[i])) {
                        pmesg(1,  __FILE__, __LINE__, "Cannot convert NaNs to ints\n");
                        *length=0;
                        *is_null=0;
                        *error=1;
            ...
            case OPH_FLOAT: //double->float
                for (i = 0; i < input->numelem; i++) {
                    if (isnan(((double *)(input->content))[i])) {
                        ((float *)(output->content))[i] = 0.0/0.0;
                    } else {
            ...
            case OPH_COMPLEX_FLOAT: //double->cfloat
                for (i = 0; i < input->numelem; i++) {
                    if (isnan(((double *)(input->content))[i])) {
                        ((float *)(output->content))[j] = 0.0/0.0;
                        ((float *)(output->content))[j+1] = 0.0/0.0;
                        j+=2;
                    } else {
