...
typedef enum { INVALID_BIT_OP, OPH_BIT_AND, OPH_BIT_OR, OPH_BIT_XOR, OPH_BIT_NAND, OPH_BIT_NOR, OPH_BIT_XNOR, OPH_BIT_GREATER_THAN, OPH_BIT_GREATER_OR_EQUAL_TO, OPH_BIT_LESS_THAN, OPH_BIT_LESS_OR_EQUAL_TO } oph_bit_op;
